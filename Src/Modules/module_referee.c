...
void Referee_Update() {                
    ...
    //Referee_UpdateCrosshair();         // draw_cnt: 0 绘制准心
    //Referee_UpdateWidthMark();         // draw_cnt: if gyro mode changed 2, else 0  绘制车宽线
    //Referee_UpdateCapState();          // draw_cnt: 1  绘制电容状态
    Referee_UpdatePitchMeter();        // draw_cnt: 1
    Referee_UpdateModeDisplay();       // draw_cnt: 0
    //Referee_UpdateErrorDisplay();      // draw_cnt: 0 错误显示
