...
void dm_motor_init(void)
{
	...
	motor[Motor1].ctrl.vel_set 	= 6.5f;			// 速度前馈  6.5
	motor[Motor1].ctrl.kp_set 	= 20.0f;		// 位置增益Kp=200
	motor[Motor1].ctrl.kd_set 	= 0.3;			// 阻尼增益Kd=3.0
	motor[Motor1].ctrl.tor_set 	= 3.0f;			// 扭矩前馈
